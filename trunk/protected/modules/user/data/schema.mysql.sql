...
INSERT INTO `Profile` (`user_id`, `lastname`, `firstname`, `birthday`) VALUES
...
INSERT INTO `ProfileField` (`id`, `varname`, `title`, `field_type`, `field_size`, `field_size_min`, `required`, `match`, `range`, `error_message`, `other_validator`, `default`, `widget`, `widgetparams`, `position`, `visible`) VALUES
